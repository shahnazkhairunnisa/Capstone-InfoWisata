...
import com.capstone.infowisata.model.ModelMain;

import java.util.List;



public class MainAdapter extends RecyclerView.Adapter<com.capstone.infowisata.adapter.MainAdapter.ViewHolder> {

    private List<ModelMain> items;
    private com.capstone.infowisata.adapter.MainAdapter.onSelectData onSelectData;

    public interface onSelectData {
        void onSelected(ModelMain mdlMain);
    }

    public MainAdapter(List<ModelMain> items, com.capstone.infowisata.adapter.MainAdapter.onSelectData xSelectData) {
        this.items = items;
