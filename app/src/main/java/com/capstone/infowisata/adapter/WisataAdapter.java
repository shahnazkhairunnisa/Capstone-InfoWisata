package com.capstone.infowisata.adapter;
...
import com.capstone.infowisata.model.ModelWisata;

import java.util.List;



public class WisataAdapter extends RecyclerView.Adapter<com.capstone.infowisata.adapter.WisataAdapter.ViewHolder> {

    private List<ModelWisata> items;
    private com.capstone.infowisata.adapter.WisataAdapter.onSelectData onSelectData;
    ...
    public WisataAdapter(Context context, List<ModelWisata> items, com.capstone.infowisata.adapter.WisataAdapter.onSelectData xSelectData) {
